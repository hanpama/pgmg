...
type selectPkOrdersQuery struct{ key PkOrders }

func (q selectPkOrdersQuery) SQL() string         { return SelectPkOrders }
func (q selectPkOrdersQuery) Args() []interface{} { return []interface{}{q.key.OrderID} }
